...
public class SwingGuiView extends JFrame implements MarbleSolitaireGuiView {
  ...
  /**
   * Constructor that initializes the model that the view will refer to.
  ...
  /**
   * Refreshes the view to update the score of the game each time a move is made.
   */
  public void refresh() {
    //refresh the score
  ...
  public void accept(IFeatures feature) {
    this.boardPanel.accept(feature);
  }
}
